...
import { Stage, Control, ICanvasData, ICanUsePattern } from '@mix-toolkit/canvas-editor/src/2d'
import { SdkContext } from '@mix-toolkit/canvas-editor/src/2d/sdk-context'
  ...
  return (
    <SdkContext.Provider value={{ sdk }}>
      <div className="flex h-screen">
        {/* 左侧Canvas区域 */}
        <Stage canvasData={canvasData} onCanvasUpdate={setCanvasData} onSdkChange={setSdk} />
